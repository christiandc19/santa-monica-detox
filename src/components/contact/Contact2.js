    ...
    <div class="contact-form-content">
      ...
      <div class="left-side">
        ...
        <div class="address details">
          ...
          <div class="text-one">729 17th St,</div>
          <div class="text-two">Santa Monica, Ca 90402</div>
        </div>

        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div><br/>
          <div class="text-one"><a href="tel:3234439924"> +1 (323) 443-9924</a></div>
        </div>

        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div><br/>
          <div class="text-one"> info@SantaMonicaDetox.biz</div>
        </div>
      </div>
